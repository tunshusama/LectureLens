...
class SkillContractTests(unittest.TestCase):
    ...
    def test_main_skill_makes_profile_questioning_scope_explicit(self):
        ...
        self.assertIn("For a different or modified PDF", entry)
        self.assertIn("would materially change the notes", entry)
    ...
    def test_output_routing_asks_before_lark_install_and_falls_back_after_decline(self):
        ...
        self.assertIn("declines installation/configuration", routing)
